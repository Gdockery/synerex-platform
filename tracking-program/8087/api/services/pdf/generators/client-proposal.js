    ...
    let docDefinition = {
      ...
      content: [
        ...
        },
        {
          ...
          text: `Proposal No.: ${clientProposalData.proposalNumber}`,
          style: {
            bold: true,
          }
        },
                  ...
                  stack: [
                    {
                      text: [
                        ...
                        'All projects incorporating SYNEREX’s Engineering and Testing Protocol are unique' +
                        ...
                        ' utility’s tariff and rate schedule. SYNEREX’s projections of kWh and kW savings are not based' +
                        ' on square footage or other traditional units of measure, but are scientifically' +
                        ' calculated based on actual reductions generated by SYNEREX’s electricity management technology.']
                    },
                    {
                      margin: [0, 5, 0, 0],
                      text: 'SYNEREX’s projection of savings is based on a comprehensive analysis of actual current' +
                      ' consumption patterns within each client facility as created by the equipment operating on' +
                      ' the electric circuit within the facility. Once the loads are identified and measured SYNEREX' +
                      ...
                      ' By analyzing the consumption patterns and the elements of the utility company’s tariff, SYNEREX' +
                      ...
                      ' relevant factors on the client’s monthly bill. Until SYNEREX has the opportunity to analyze an' +
                      ' electric bill and create a comprehensive Bill Analytic Report it is not possible for SYNEREX to' +
                      ' present an accurate projection of the kWh or total annual kW savings without using imprecise' +
                      ' estimates. The SYNEREX approach is unique and the results are immediately measureable based on' +
        ...
        },
        {
          ...
          stack: [
                ...
                {
                  text: `- Minimum SYNEREX BASELINE SAVINGS: ${clientProposalData.estimatedSavings.baselineSavingsPercent}% reduction in electricity consumption monthly`,
                  style: {
                    bold: true,
                  },
                },
                ...
                {
                  text: `- Recommended number of SYNEREX units to be installed in the facility: ${clientProposalData.estimatedSavings.xecoUnits}`,
                  style: {
                    bold: true,
                  },
                },
        ...
        },
        {
          ...
          stack: [
                {
                  text: 'Following the receipt of a Purchase Order authorizing the start of the EMS project SYNEREX will invoice the organization' +
                    ' as follows:',
                  style: {
                    fontSize: 9
                  }
                ...
                {
                  text: `2. Payment after installation of the equipment and Synerex’s Installation verification (30%) – ${clientProposalData.installationAmount}`,
                  margin: [20, 0, 0, 0],
                  style: {
                    fontSize: 8.5
                  }
                ...
                {
                  text: `${clientProposalData.clientName} will provide SYNEREX with an open Purchase Order covering the three payments per the agreement prior to installation.`,
                  margin: [0, 10, 0, 10],
                },
                {
        ...
        },
        {
          ...
          text: [
            ...
            ' Synerex Certified Program Managers and Engineers ................................................... 9'
          ],
          style: {
            fontSize: 9
          }
        ...
        },
        {
          ...
          text: [
            ...
            ' Synerex Engineering Experience ...................................................................................... 9'
          ],
          style: {
            fontSize: 9
          }
        ...
        },
        {
          ...
          text: [
            {
              text: 'SYNEREX SENIOR MANAGEMENT TEAM',
              style: {
                bold: true
              }
            },
        ...
        {
          margin: [0, 5, 0, 0],
          text: 'SYNEREX has developed the most compelling Electricity Management Solution (EMS) solution on the market' +     
                ...
                ' timely and accurate decision making. SYNEREX’s solution is fundamentally a Power Quality Improvement' + 
          ...
          table: {
            ...
            body: [
              [
                {
                  margin: [30, 5, 0, 0],
                  text: 'SYNEREX’s Value Proposition',
                  style: {
                    alignment: 'left',
                    bold: true,
                    color: 'white',
        ...
        },
        {
          ...
          text: brandName.toUpperCase() + ' Energy Corporation' + ' has created a highly productive electricity management solution by integrating our' + 
                ' proprietary SYNEREX Power System (XPS) hardware technology with a comprehensive reporting system in order to' + 
                ...
                ' research and field testing SYNEREX has developed an engineering tool capable of determining the guaranteed baseline' + 
        ...
        },
        {
          ...
          text: 'The tool also specifies the hardware/software and one-time installation costs necessary to produce the guaranteed' + 
                ' savings, thereby facilitating the ROI calculation for the EMS installation. Post installation SYNEREX’s information' + 
                ...
                ' the capability to verify the savings post-installation allows SYNEREX to offer each client a performance guarantee which' + 
        ...
        },
        {
          ...
          ul: [
            {
              margin: [0, 5, 0, 0],
              text: 'SYNEREX offers each client a recurring energy saving guarantee'
            },
            {
              margin: [0, 5, 0, 0],
              text: 'SYNEREX’s solution provides for direct and measurable electricity cost savings, reduced' + 
            ...
            },
            {
              ...
              text: 'With more than 3,500 XPS units installed in the U.S., Mexico, China and Belgium (as of' +
                    ' February 2020) Synerex has an established track record for evidenced-based performance' + 
                    ' across multiple industry segments;',
            },
            {
              margin: [0, 5, 0, 0],
              text: 'SYNEREX’s technology is a solid-state electronics platform, easily installed within existing' + 
                    ' facilities, requiring no maintenance or calibration, with a life expectancy of twenty years or' + 
                    ' more; and',
            },
            {
              margin: [0, 5, 0, 0],
              text: 'Synerex’s technology has been awarded the ETL, UL and CE marks of approval.'
            },
          ],
          style: {
            fontSize: 9,
        ...
        {
          margin: [0, 15, 0, 0],
          text: 'SYNEREX’s EMS project return on investment and cost of ownership set the industry standard. The ROI calculations for SYNEREX’s EMS' + 
                ...
                ' months.  Cost of ownership of the installed solution is negligible. Since SYNEREX’s maintenance-free technology is based on solid-' + 
                ' state electronics there is no ongoing support costs are virtually eliminated. SYNEREX’s technology has currently been installed for' + 
                ...
                ' installed by SYNEREX in each facility. ',
          style: {
            fontSize: 9
          }
        },
          ...
          table: {
            ...
            body: [
              [
                {
                  margin: [30, 5, 0, 0],
                  text: ' SYNEREX Solution Overview',
                  style: {
                    alignment: 'left',
                    bold: true,
                    color: 'white',
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'SYNEREX’s approach to electricity management is a significant departure from traditional energy management' + 
                ' ystems. SYNEREX’s solution includes a proprietary hardware technology that tunes the 60 hertz frequency to' + 
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'SYNEREX’s approach to electricity management is based on the following assumption and a unique approach:',
          style: {
            fontSize: 9
          }
        },
        ...
        {
          margin: [0, 10, 0, 0],
          text: '6 The following two graphics represent the impact SYNEREX’s 60 Hz tuning has on the Current Flow within each electrical network:',
          style: {
            fontSize: 9
          }
        },
        ...
        {
          margin: [0, 10, 0, 0],
          text: '7 The next graphic demonstrates the actual improvement in Power Quality Improvement and reduction in AMP Loads SYNEREX’s technology creates within an electrical circuit:',
          style: {
            fontSize: 9
          }
        },
        ...
        {
          margin: [0, 10, 0, 0],
          text: '8 The final graphic indicates the actual improvement in power quality SYNEREX’s technology had on an electrical circuit:',
          style: {
            fontSize: 9
          }
        },
          ...
          table: {
            ...
            body: [
              [
                {
                  margin: [30, 5, 0, 0],
                  text: ' SYNEREX’s Information Reporting',
                  style: {
                    alignment: 'left',
                    bold: true,
                    color: 'white',
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'After the hardware components of the EMS have been installed and activated SYNEREX will enable the information' + 
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'SYNEREX’s information reporting system provides a perpetual financial accounting and facility operations reporting platform that' + 
          ...
          table: {
            ...
            body: [
              [
                {
                  margin: [30, 5, 0, 0],
                  text: ' SYNEREX Hardware Overview',
                  style: {
                    alignment: 'left',
                    bold: true,
                    color: 'white',
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'SYNEREX\'s proprietary \'Current-Balancing\' technology is the company\'s latest technological advancement that produces' +
                ' measurable reductions in electricity consumption and improves the operating efficiency of electric loads. SYNEREX\'s' +
        ...
        },
        {
          pageBreak: 'after',
          margin: [0, 15, 0, 0],
          text: 'SYNEREX’s solution is compatible with all international electrical networks and is applicable for most' +
                ' commercial and industrial facilities. The SYNEREX Power System (XPS) technology is complemented by' +
                ' SYNEREX’s exclusive Engineering and Testing Protocol (ETP) that facilitates a comprehensive analysis of the' +
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'Example of Synerex Power Quality Improvement',
          style: {
            fontSize: 11,
            color: green,
          }
        ...
        {
          margin: [10, 15, 0, 0],
          text: 'SYNEREX’S SOFTWARE MODULES',
          style: {
            fontSize: 10,
            color: green,
          }
          ...
          table: {
            ...
            body: [
              [
                {
                  margin: [30, 5, 0, 0],
                  text: 'Synerex Validation Methodology',
                  style: {
                    alignment: 'left',
                    bold: true,
                    color: 'white',
                ...
                //-------------------Page 9 - MARKET ASSESSMENT, PATH TO MARKET GROWTH-------------------
        {
          pageBreak: 'after',
          margin: [0, 15, 0, 0],
          text: 'SYNEREX uses a scientific and comprehensive engineering methodology to determine the financial and' +
                ' operational benefits a customer can expect when purchasing the SYNEREX Power Systems Electricity' +
                ' Management System. The approach is a simple step by step \'make\'s sense\' process that produces' +
                ' information that will identify, qualify, justify, and validate that the use of SYNEREX’s technology will' + 
        ...
        },
        {
          ...
          text: 'Once the economic value and ROI period are established the prospective buyer has all the data' + 
                ...
                ' after Synerex’s technology has been installed. The verification of performance and benefits is executed' + 
        ...
        {
          margin: [0, 20, 0, 0],
          text: 'The SYNEREX electricity management solution has been commercially available since 2009. The install' +
                ' base has evolved from small to midsize commercial facilities to large complex industrial facilities.' +
                ' Because SYNEREX’s protocol produces a ‘customized’ configuration for every facility the results are' +
                ' specific and unique to each. SYNEREX equipment has been installed in a wide variety of facilities across' +
                ' fifty-two different industry segments. Because of the proven results produced by the solution SYNEREX' +
        ...
        {
          margin: [0, 20, 0, 0],
          text: 'SELECT SYNEREX CLIENT INSTALLATIONS',
          style: {
            fontSize: 11,
            color: titleBlue, 
          }
        ...
        {
          margin: [0, 0, 0, 0],
          text: 'Synerex’s installation sites include but are not limited to facilities owned and operated by the following:',
          style: {
            fontSize: 9,
          }
        },
        {
          margin: [0, 20, 0, 0],
          text: 'SYNEREX’s corporate target for the reduction of electricity consumption in each client facility is 8% to 12%' +
                ...
                ' contribute to the inductive load, the measurable performance of SYNEREX’s solution will vary.',
          style: {
            fontSize: 9
          }
        },
        ...
        {
          text: 'SYNEREX’s exclusive Engineering and Testing Protocol provides an efficient, logical, step-by-step process to determine' +
                ' the economic value, justification, and business case for implementing a measurable electricity management' + 
                ' solution. During Step 1 of SYNEREX’s protocol a certified engineer will use the information from a client’s most' + 
        ...
        },
        {
          ...
          ul: [
            ...
            {
              margin: [0, 5, 0, 0],
              text: 'SYNEREX’s projected monthly savings amount',
            },
            {
              margin: [0, 5, 0, 0],
              text: 'Cost of SYNEREX’s solution',
            },
            {
              margin: [0, 5, 0, 0],
        ...
        //-------------------Page 11 - SYNEREX’S CERTIFIED PROJECT MANAGERS AND ENGINEERS-------------------
        {
          text: 'The Bill Analytic data is a vital component to establish the feasibility of launching a project and' +
                ' determining the scope of benefits to be obtained from the use of SYNEREX’s solution. Once' + 
                ' completed, the Bill Analytic Report is reviewed with the Client and assuming the data' +
                ' contained in the report is compelling it is appropriate to move to the next step in SYNEREX’s' +
                ' protocol.',
          style: {
            fontSize: 9
          }
        ...
        {
          text: 'This step in the process requires a Certified SYNEREX Project Manager to identify all the active' + 
        ...
        {
          margin: [0, 20, 0, 0],
          text: 'SYNEREX’S CERTIFIED PROJECT MANAGERS AND ENGINEERS',
          style: {
            fontSize: 11,
            color: titleBlue, 
          }
        ...
        {
          text: 'Once the SYNEREX \'walk-through\' has been completed, the SYNEREX Project Manager will enter the collected' +
        ...
        },
        {
          ...
          columns: [
            {
              width: '*',
              text: 'Each SYNEREX Project manager has been completely trained and' +
                    ' certified by Certified Instructors for managing the SYNEREX' + 
        ...
        },
        {
          text: 'After the customer reviews and accepts the proposal, the next step is to obtain a signed agreement on ' + 
                ' the SYNEREX Power Systems Installation work order. The installation work order will detail the' + 
                ' installation schedule and the roles and responsibilities of all parties involved. Once the installation' + 
                ' schedule has been developed, SYNEREX will coordinate the physical installation plan with the customer' + 
                ' and/ or third party resources to complete the process. Once the installation of the SYNEREX Power' + 
                ...
                ' monthly basis and storage of the data on Synerex’s Secure Server for management retrieval.',
          style: {
            fontSize: 9
          }
        },
        ...
        {
          text: 'The meters installed by SYNEREX Engineers will enable ‘full facility’ metering of electricity consumption' + 
                ...
                ' case and justification for the SYNEREX installation. The metering test will collect data with SYNEREX’s' + 
                ...
                ' essentially immediate confirmation of the value produced by SYNEREX’s installation. A certified' + 
                ...
                ' validate the results of the successful SYNEREX energy management project.',
          style: {
            fontSize: 9
          }
        },
        {
          margin: [0, 20, 0, 0],
          text: 'SYNEREX ENGINEERING EXPERIENCE',
          style: {
            fontSize: 11,
            color: titleBlue, 
          }
        ...
        {
          text: 'SYNEREX\'s proprietary \'Current-Balancing\' technology is in a league of its own. With over 22 years of research,' + 
                ' field testing and design, SYNEREX engineers have developed a complete turnkey hardware and software' + 
        ...
        {
          text: 'Synerex is excited about the opportunity to install the latest in energy management technology to your facility.' +
        ...
        {
          margin: [0, 20, 0, 0],
          text: 'Synerex’s engineering protocol was used to produce a Bill Analytic Report based on the January 2018 electric bill' +
        ...
        },
        {
          ...
          text: `Below is the summary page from the Bill Analytic Report for ${clientProposalData.clientAddress} facility. The estimated savings is` +
                ...
                ' during the ‘Walk Through’ process. The quantity of SYNEREX units and other adjustments to the' +
            ...
            body: [
              ...
              [
                ...
                },
                {
                  ...
                  text: 'SYNEREX Savings ' + clientProposalData.projectCurrency,
                  style: {
                    alignment: 'right',
              ...
              [
                ...
                },
                {
                  margin: [0, 5, 0, 0],
                  border: noBordersCell,
                  text: 'Cost for SYNEREX Equipment & Parts:',
                  style: {
                    alignment: 'right',
                    italics: true,
                    fontSize: 7
        ...
        {
          text: 'Add’l Note: Estimated number of Synerex units are subject to change after ‘Walk-Through’ process has been completed.',
          style: {
            fontSize: 8,
            bold: true
          },
        ...
        //-------------------Page 13 - SYNEREX’S DRAFT STATEMENT OF WORK-------------------
        {
          margin: [-50, 20, -50, 0],
          layout: 'noBorders',
          table: {
        ...
        {
          margin: [0, 10, 0, 0],
          text: 'SYNEREX DRAFT STATEMENT OF WORK',
          style: {
            bold: true,
            alignment: 'center',
            fontSize: 14
        ...
        },
        {
          ...
          ' step in SYNEREX’s engineering and testing protocol the all relevant information for the implementation of' +
          ' the XPS configuration will be specifically documented in SYNEREX’s proposal. The roles and responsibilities' +
        ...
        },
        {
          ...
          ' All implementation timelines will be specified in SYNEREX’s proposal.',
          style: {
            fontSize: 9
          }
        },
        ...
        },
        {
          pageBreak: 'after',
          margin: [0, 5, 0, 0],
          text: 'From the first step to the last step in SYNEREX’s Engineering and Testing Protocol there' + 
                ' are projections and verifications of the economic benefits to be obtained from the' + 
                ' deployment of the SYNEREX technology. The method of developing the initial value' + 
                ' proposition and business case for the procurement of SYNEREX’s solution is based on' + 
                ' client data obtained from the electric bill and the electric utility’s tariff.' + 
                ' Once SYNEREX prepares the Bill Analytic Report and completes the facility ‘walk-thru’' + 
                ' the client and SYNEREX are in a qualified position to reach agreement on the' + 
                ' expectations for economic and operational performance by the recommended' + 
                ' SYNEREX technology configuration. From that point on SYNEREX and the client or the' + 
        ...
        {
          margin: [0, 5, 0, 0],
          text: 'During the installation SYNEREX Engineers will install a ‘full facility’ metering system' + 
                ...
                ' SYNEREX installation. The metering test will collect data with the SYNEREX configuration' + 
                ...
                ' confirmation of the value produced by the SYNEREX installation. As such a certified' + 
                ' engineer will have ample information to prepare a comprehensive engineering' + 
                ' report for the client’s management team documenting SYNEREX’s impact on each' + 
                ' circuit in the facility along with the full-facility metering test data that' + 
                ' substantiates the results of the successful SYNEREX energy management project.',
          style: {
            fontSize: 9
          }
        },
        ...
        {
          margin: [0, 5, 0, 0],
          text: 'Prior to SYNEREX equipment installation, a qualified SYNEREX Project Manager will visit FACILITY to' +
                ' verify Bill Analytic assumptions and findings, refine and finalize the minimum guaranteed' + 
                ' SYNEREX savings to be derived from installation. CUSTOMER will provide a Purchase Order for' + 
                ' the full amount to be paid to SYNEREX, specific terms of payment and verification of funds to be' +
                ' exercised pending engineering verification of delivered value. With this Purchase Order in' + 
                ' hand, SYNEREX will schedule FACILITY installation.',
          style: {
            fontSize: 9
          }
        },
        {
          ...
          text: 'Upon FACILITY installation and engineering verification of performance (refer to below' +
                ...
                ' presented by SYNEREX for the CUSTOMER FACILITY, CUSTOMER will remit payment to SYNEREX in' + 
        ...
        },
        {
          ...
          text: 'Immediately following the installation of the proposed configuration at FACILITY' + 
                ' SYNEREX will conduct a facility-wide engineering test to verify the savings specified in' + 
        ...
        },
        {
          ...
          text: 'In the event the post-installation test of the installed configuration does not produce' + 
                ' measurable results that meet or exceed the performance criteria quoted by SYNEREX for the' + 
        ...
        },
        {
          ...
          ul: [
            {
              margin: [0, 5, 0, 0],
              text: 'SYNEREX will take the appropriate steps to adjust the installed configuration in' + 
            ...
            },
            {
              ...
              text: 'Should additional equipment and/or labor be required during' + 
                    ' the thirty-day period it will be provided by SYNEREX at no' + 
                    ' additional cost to CUSTOMER.',
            },
            {
              margin: [0, 5, 0, 0],
              text: 'Prior to the end of the thirty (30) day post-installation adjustment' + 
                    ' period, if required, CUSTOMER and SYNEREX will review all new test data' + 
                    ' and agree that the performance criteria originally quoted are being met' + 
                    ' or exceeded.', 
            },
            {
              margin: [0, 5, 0, 0],
              text: 'If the CUSTOMER and SYNEREX are unable to agree within the initial thirty (30)' + 
                    ' days post- installation period that there is measurable results that meet or' + 
                    ' exceeded the performance criteria established for the facility, SYNEREX shall' + 
                    ' have an additional thirty (30) days to resolve the performance issues.' + 
                    ' If within sixty (60) days post installation SYNEREX is unable to produce', 
            },
            {
              margin: [0, 5, 0, 0],
              text: 'If within sixty (60) days post installation SYNEREX is unable to produce' + 
                    ' measurable results that meet or exceed the performance criteria quoted for' + 
                    ' the facility, and the CUSTOMER and SYNEREX are unable to agree on revised' + 
                    ' performance criteria, SYNEREX will refund all payments made by CUSTOMER to' + 
                    ' SYNEREX minus any installation labor costs paid by Synerex.', 
            },
          ],
          style: {
            fontSize: 9,
        ...
        {
          margin: [0, 5, 0, 0],
          text: 'SYNEREX has implemented a quality control system to ensure that this project meets or exceeds the' +
        ...
        },
        {
          ...
          text: 'Dockery brings over 35 years of experience as a CEO for technology design, electronics manufacturing,' + 
                ' distribution and international marketing operations to his role at Synerex.',
          style: {
            fontSize: 9
          }
        },
        {
          ...
          text: [
            ...
            { text: 'Paul has been a member of Synerex’s management team' + 
                ' for more than the twelve years. Prior to Synerex Paul has worked on the leading edge of the global technology' + 
        ...
        },
        {
          ...
          text: [
            ...
            { text: 'R. Gordon Jones graduated from Brigham Young' + 
                    ...
                    ' auditors. Gordon has been with Synerex since 2008.',
            }, 
          ], 
          style: {
            fontSize: 9
        ...
        },
        {
          ...
          margin: [0, 20, 0, 0],
          text: [
            { text: 'Kamal Kawalramani, Managing Director of Synerex Taiwan, Manufacturing and Operations:',
              style: {
                bold: true, 
              },
            },
            { text: ' Kamal is responsible for the complete quality control of all the goods produced, manufactured' + 
                ' and installed by Synerex. The goods include a wide range of electronic devices including wireless speakers, wireless ' + 
        ...
        },
        {
          ...
          margin: [0, 15, 0, 0],
          stack: [
            { text: 'Synerex Performance Guarantee Policy',
              style: {
                bold: true, 
                fontSize: 15,
                alignment: 'center'
            ...
            { 
              margin: [0, 10, 0, 0],
              text: `The primary objective of Synerex\'s EMS is to save  ${clientProposalData.clientName} money. Our performance guarantee policy is to` +
                    ' ensure your investment in Synerex’s technology will be repaid many times. The intent of this section of the proposal is to' +
                    ' clarify Synerex determines the baseline savings Key Performance Indicator (KPI) as well as to explain how and when Synerex will' +
            ...
            { 
              ...
              text: 'Our standard approach for every EMS project is to start performance testing following the installation and activation of the' +
                    ...
                    ` guarantee. In the event the test results do not validate the baseline savings guarantee of ${clientProposalData.estimatedSavings.baselineSavingsPercent}% for the installed facility Synerex` +
                    ' will immediately begin the process of diagnosing and resolving the performance issue. If Synerex is required to install' +
            ...
            { 
              margin: [0, 10, 0, 0],
              text: 'In the unlikely event that within sixty days following the start of the performance testing period Synerex is unable to meet or' +
                    ...
                    ' Synerex to remove the installed EMS solution, and receive a refund of all payments made to Synerex, or ${clientProposalData.clientName} can' +
            ...
            { 
              margin: [20, 5, 0, 0],
              text: '• Synerex EMS purchase price - $350,000'
            },
            { 
              margin: [20, 0, 0, 0],
            ...
            { 
              ...
              text: 'Included in the purchase price of the EMS is the cost of the Annual Metering/Server Fee as specified in the proposal.' +
                    ' The fee covers the support cost for the secure on-site server and the software license for Synerex’s Information Reporting System' + 
                    ...
                    ' and must be prepaid annually or in monthly installments. The key feature of the Information Reporting System is Synerex’s Energy Savings' +
                    ' Report (ESR) which is designed to document the monthly energy savings and the financial impact generated by Synerex’s EMS.',
            },
            { 
              margin: [0, 10, 0, 0],
              text: 'Following the completion of the performance test period and verification of the proposed or revised (if appropriate) baseline savings' +
                    ' guarantee for the facility, Synerex\'s Information Reporting System will begin generating an Energy Savings Report (ESR) every month based' +
            ...
            { 
              ...
              text: 'It is a given that electricity consumption in the plant will not be the same every month and therefore the savings amount will vary month to month.' +
                    ...
                    ` exceed the savings guarantee. It is critical that both ${clientProposalData.clientName} and Synerex have an accurate measure of savings every month for comparison` +
            ...
            { 
              ...
              text: 'At the end of the twelve-month period following the completion of the post installation EMS performance testing and verification of the savings baseline' +
                    ` KPI, ${clientProposalData.clientName} and Synerex personnel will review the Energy Savings Report to determine if the baseline savings for the period equals the savings` +
                    ...
                    ` Synerex will calculate and issue a credit to ${clientProposalData.clientName} in an amount equal to the difference between the savings guarantee and the actual savings` +
                    ...
                    ' the savings guarantee during any of the twelve-month periods, Synerex will calculate the value of the over performance and may apply it to any credits due' +
            ...
            { 
              margin: [0, 10, 0, 0],
              text: `Assuming ${clientProposalData.clientName} continues to subscribe to the Annual Metering/Server Fee for Synerex’s Information Reporting System, the ESR review process` +
                    ...
                    ' in the facility which may require a recalculation of the KPI or the purchase of additional Synerex equipment.',
            },
          ], 
          style: {
            fontSize: 9
