module.exports = {
  ...
  friendlyName: 'List project repeater alerts',


  description: 'List all the repeater alert groups for a project.',
  ...
  fn: function (inputs, exits) {
    ...
    sails.helpers.web.alerts.listAlerts(_.extend({ deviceType: 'repeater' }, inputs)).exec(exits);
