module.exports = {
  ...
  friendlyName: 'Unhide data rows',


  description: 'Unhide one or more rows of data from a test.',
  ...
  inputs: {
    ...
    id: {
      description: 'The ID of the test to unhide data rows for.',
      example: 123,
      required: true
    },

    rowIds: {
      description: 'The IDs of the meter data rows to unhide.',
      example: [1],
      required: true
    }
  ...
  fn: function (inputs, exits) {
    ...
    .exec(function(err, test) {
      ...
      .exec(function(err, rows) {
        ...
        var hiddenMeterDataRowIds = _.difference(test.hiddenMeterDataRowIds, inputs.rowIds);
