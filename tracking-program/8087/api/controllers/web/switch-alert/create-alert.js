module.exports = {
  ...
  description: 'Create a new switch alert group.',
  ...
  inputs: {
    ...
    threshold: {
      ...
      extendedDescription: 'Must be a positive integer. For `GATEWAY_ERROR` alerts, the amount of time that the switch must be offline before triggering an alert.',
      example: 200,
      required: true
    },
    ...
    switches: {
      ...
      extendedDescription: 'Must contain at least one switch ID.',
      example: [1],
      required: true
    },
  ...
  fn: function (inputs, exits) {
    ...
    sails.helpers.web.alerts.createAlert(_.extend({ deviceType: 'switch', devices: inputs.switches }, _.omit(inputs, 'switches'))).exec(exits);
