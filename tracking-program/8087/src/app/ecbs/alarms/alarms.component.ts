...
export class AlarmsComponent implements OnInit {
  ...
  get totalAlarms7d(): number      { return this.summary?.total_7d    ?? (this.historyAlarms.length + this.alarms.length); }
  ...
  get historyHasData(): boolean { return this.historyDays.some(d => d.critical + d.warning + d.info > 0); }
  ...
  timelineSeverityColor(sev: string): string { return this.severityColor(sev); }
