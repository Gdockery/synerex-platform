...
with app.app_context():
    db.create_all()
    from app.db_migrations import add_client_taxid_column, add_client_created_by_column, add_client_org_id_column, add_project_org_id_column, add_project_slug_column, add_project_xecobase_columns, add_user_logo_column, add_mesh_ip_columns, add_meter_xecobase_columns, add_meterdataaggregate_multiplier_column, add_schedule_xecobase_columns, add_emv_analysis_table, add_active_emv_analysis_to_project, ensure_synerex_admin_user
