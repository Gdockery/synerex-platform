...
class ProgramAuthorization(Base):
    ...
    authorization_id: Mapped[str] = mapped_column(String(255), primary_key=True)
    ...
    status: Mapped[str] = mapped_column(String(255), default="active")   # active|suspended|terminated
    starts_at: Mapped[str] = mapped_column(String(255), nullable=False)  # YYYY-MM-DD
    ends_at: Mapped[str] = mapped_column(String(255), nullable=False)
