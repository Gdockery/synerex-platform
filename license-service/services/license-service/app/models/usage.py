...
class UsageEvent(Base):
    ...
    license_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)
    ...
    event_type: Mapped[str] = mapped_column(String(255), nullable=False)  # e.g., "feature_used", "api_call", "login"
