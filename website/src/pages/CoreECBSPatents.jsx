      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Current Balancing Algorithms</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Control Methodologies</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">System Architectures</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Three-Phase Network Integration</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Power Quality Optimization</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Adaptive Control Systems</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Network-Wide Deployment</h3>
        ...
        <div className="mt-12 p-6 border bg-gray-800">
          <h3 className="font-bold text-purple-200 mb-4">Core ECBS Patent Portfolio</h3>
          <ul className="text-sm text-gray-300 space-y-2">
            <li>• <a href="https://patents.google.com/patent/US12375324B2" target="_blank" rel="noopener noreferrer" className="text-purple-200 hover:text-purple-200 underline">US 12375324B2 — Advanced ECBS Technology</a></li>
