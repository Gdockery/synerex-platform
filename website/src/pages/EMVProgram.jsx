      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              ...
              className="px-6 py-3 bg-purple-500 hover:bg-purple-300 rounded-lg font-semibold transition-colors"
            >
              Get Licensed
            </Link>
            <Link
        ...
        <section className="mb-16">
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
            <h2 className="text-3xl font-bold mb-6 text-purple-200">Program Overview</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 hover:border-purple-200 transition-colors">
                <h3 className="text-xl font-bold mb-2 text-purple-200">Real-Time Analysis</h3>
                <p className="text-gray-400">Continuous monitoring and analysis of power quality metrics</p>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 hover:border-purple-200 transition-colors">
                <h3 className="text-xl font-bold mb-2 text-purple-200">Audit-Grade Accuracy</h3>
                <p className="text-gray-400">Meets IEEE, ASHRAE, and IEC standards for measurement precision</p>
              </div>
              <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 hover:border-purple-200 transition-colors">
                <h3 className="text-xl font-bold mb-2 text-purple-200">Utility-Grade Submission</h3>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-200">IEEE Standards</h3>
            ...
            {/* ASHRAE Standards */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-200">ASHRAE Standards</h3>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">•</span>
            ...
            {/* IEC Standards */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-200">IEC Standards</h3>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">•</span>
            ...
            {/* ANSI Standards */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-200">ANSI Standards</h3>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">•</span>
            ...
            {/* NEMA Standards */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-200">NEMA Standards</h3>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">•</span>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-200">IPMVP & Other Standards</h3>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">•</span>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Power Quality Analysis</h3>
            ...
            {/* Feature 2 */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Energy Savings Measurement</h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">✓</span>
            ...
            {/* Feature 3 */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Advanced Metering & Data Quality</h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">✓</span>
            ...
            {/* Feature 4 */}
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Compliance & Statistical Analysis</h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-purple-200 mr-2">✓</span>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-purple-200">Complete Audit Trail</h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-purple-200 mr-2">✓</span>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-purple-200">Submission-Ready Documentation</h3>
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-purple-200 mr-2">✓</span>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-purple-950/30 to-blue-900/30 rounded-xl p-8 border border-purple-700/50 hover:border-purple-200 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Utility-Grade Precision</h3>
            ...
            <div className="bg-gradient-to-br from-purple-950/30 to-blue-900/30 rounded-xl p-8 border border-purple-700/50 hover:border-purple-200 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Complete Regulatory Compliance</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-purple-950/30 to-blue-900/30 rounded-xl p-8 border border-purple-700/50 hover:border-purple-200 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Investment-Grade Documentation</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-purple-950/30 to-blue-900/30 rounded-xl p-8 border border-purple-700/50 hover:border-purple-200 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Comprehensive Audit Trail</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-purple-950/30 to-blue-900/30 rounded-xl p-8 border border-purple-700/50 hover:border-purple-200 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Time & Cost Savings</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-purple-950/30 to-blue-900/30 rounded-xl p-8 border border-purple-700/50 hover:border-purple-200 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Single Platform Solution</h3>
              <p className="text-gray-300 leading-relaxed">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Energy Service Companies (ESCOs)</h3>
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Utilities</h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Facility Managers</h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-purple-200/50 transition-colors">
              <h3 className="text-2xl font-bold mb-4 text-purple-200">Consultants & Engineers</h3>
              <p className="text-gray-300 mb-4">
        ...
        <section className="mb-16">
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
            <h2 className="text-3xl font-bold mb-6 text-purple-200">Technical Specifications</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-purple-700/50 to-blue-900/50 rounded-xl p-8 border border-purple-700/50 text-center">
            <h2 className="text-3xl font-bold mb-4 text-purple-200">Ready to Get Started?</h2>
        ...
        <section className="text-center">
          <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
            <h2 className="text-3xl font-bold mb-4 text-purple-200">Have Questions?</h2>
            <p className="text-lg text-gray-300 mb-6">
              Our team is ready to help you understand how the EM&V program can meet your specific needs.
            </p>
            <Link
              to="/contact"
              className="inline-block px-5 py-3 bg-purple-500 hover:bg-purple-300 rounded-lg font-semibold transition-colors"
            >
              Contact Us
            </Link>
          </div>
