        ...
        <div className="mt-16 text-center">
          <div className="p-8 rounded-xl border border-gray-700 bg-gray-800 rounded-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact" 
                className="px-6 py-3 bg-purple-500 text-white rounded-lg hover:bg-purple-300 transition-colors"
              >
                Contact Us
              </a>
              <a 
                href="/downloads" 
                className="px-6 py-3 border border-purple-400 text-purple-200 rounded-lg hover:bg-purple-300/30 transition-colors"
              >
                Download Resources
              </a>
            </div>
