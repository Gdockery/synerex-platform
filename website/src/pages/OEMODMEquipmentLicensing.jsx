      ...
      <section className="relative from-gray-900 via-purple-950 to-gray-900 bg-gradient-to-br pt-32 pb-24 px-4 text-center text-white">
        ...
        <div className="fade-in" style={{ zIndex: 1 }}>
          ...
          <div className="mb-6 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-purple-200 mb-4">OEM / ODM Equipment Licensing Programs</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">White-Label Solutions</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Co-Development Programs</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Manufacturing Support</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Market Support</h3>
