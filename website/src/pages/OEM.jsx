...
.fade-in {
      ...
      <section className="relative from-gray-900 via-purple-950 to-gray-900 bg-gradient-to-br pt-32 pb-24 px-4 text-center text-white">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/web-images/Synerex_OEM_Manufacturing.jpeg)',
            zIndex: 0
          }}
        />
    ...
    <section className="max-w-7xl mx-auto px-4 py-10 space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <button onClick={()=>setNdaOpen(true)} className="px-4 py-1.5 rounded-lg bg-purple-500 hover:bg-purple-300 text-white">Request NDA</button>
      </div>
