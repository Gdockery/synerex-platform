      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/power-quality-improvement" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Power Quality Improvement</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/network-stability" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Network Stability</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/energy-efficiency" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Energy Efficiency</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/equipment-protection" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Equipment Protection</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/scalable-implementation" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Scalable Implementation</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/real-time-monitoring" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Real-time Monitoring</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/compliance-standards" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Compliance & Standards</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/cost-savings" className="hover:text-purple-200">
