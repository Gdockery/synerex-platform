      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/core-ecbs-patents" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Core ECBS Patents</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/control-systems" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Control Systems</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/hardware-implementation" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Hardware Implementation</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/software-analytics" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Software & Analytics</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/application-specific" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Application-Specific</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/licensing-commercialization" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Licensing & Commercialization</h3>
            </a>
        ...
        <div className="mt-12 p-6 border bg-gray-800">
          <h3 className="font-bold text-purple-200 mb-4">Intellectual Properties Portfolio</h3>
        ...
        <div className="mt-8 p-6 border bg-gray-800">
          <h3 className="font-bold text-purple-200 mb-4">Portfolio Overview</h3>
          <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-300">
            <div>
              <h4 className="font-semibold text-purple-200 mb-2">Patent Categories</h4>
            ...
            <div>
              <h4 className="font-semibold text-purple-200 mb-2">Patent Status</h4>
              <ul className="space-y-1">
            ...
            <div>
              <h4 className="font-semibold text-purple-200 mb-2">Licensing Options</h4>
              <ul className="space-y-1">
