...
.fade-in {
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-2xl font-bold text-purple-200 mb-4">Our Mission</h2>
            ...
            <h2 className="text-2xl font-bold text-purple-200 mb-4">Our Technology</h2>
            <p className="text-gray-300 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-purple-200 mb-4">What We Offer</h2>
            ...
            <h2 className="text-2xl font-bold text-purple-200 mb-4 mt-8">Our Commitment</h2>
            <p className="text-gray-300 mb-6">
