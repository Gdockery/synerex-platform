      ...
      <section className="relative from-gray-900 via-purple-950 to-gray-900 bg-gradient-to-br pt-32 pb-24 px-4 text-center text-white">
        ...
        <div className="fade-in" style={{ zIndex: 1 }}>
          ...
          <div className="mb-6 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-purple-200 mb-4">Trademark and Brand Asset Licensing Programs</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/brand-asset-licensing" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Brand Asset Licensing</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/product-co-branding" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Product Co-Branding</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/quality-control-standards" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Quality Control Standards</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/marketing-authorization" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Marketing Authorization</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/territorial-rights" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Territorial Rights</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/brand-protection" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Brand Protection</h3>
            </a>
