      ...
      <section className="relative from-gray-900 via-purple-950 to-gray-900 bg-gradient-to-br pt-32 pb-24 px-4 text-center text-white">
        ...
        <div className="fade-in" style={{ zIndex: 1 }}>
          ...
          <div className="mb-6 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-purple-200 mb-4">Patented Technology Licensing Programs</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/intellectual-properties-portfolio" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">ECBS Patent Portfolio</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/field-of-use-flexibility" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Field-of-Use Flexibility</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/technology-transfer-support" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Technology Transfer Support</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/licensing-models" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Licensing Models</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/patent-enforcement" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Patent Enforcement</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/strategic-partnerships" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Strategic Partnerships</h3>
            </a>
