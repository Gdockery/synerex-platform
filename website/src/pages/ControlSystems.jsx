      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Intelligent Scheduling</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Wireless Communication Protocols</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Adaptive Algorithms</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Predictive Control</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Fault Detection & Diagnostics</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Multi-Unit Coordination</h3>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <h3 className="font-bold text-purple-200">Network Integration</h3>
        ...
        <div className="mt-12 p-6 border bg-gray-800">
          <h3 className="font-bold text-purple-200 mb-4">Control Systems Patent Portfolio</h3>
