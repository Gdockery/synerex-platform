...
.fade-in {
      ...
      <section className="relative from-gray-900 via-purple-950 to-gray-900 bg-gradient-to-br pt-32 pb-24 px-4 text-center text-white">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/web-images/Synerex_Custom_PCB_Design.jpeg)',
            zIndex: 0
          }}
        />
        ...
        <div className="fade-in relative" style={{ zIndex: 1 }}>
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-200 mb-6">
              <strong>SYNEREX</strong> (<strong className="text-purple-200">SYN</strong>ergistic <strong className="text-purple-200">E</strong>nergy <strong className="text-purple-200">R</strong>esearch and <strong className="text-purple-200">EX</strong>ecution) operates as a research and development laboratory specializing in advanced power quality technologies and infrastructure-level electrical optimization. Through its custom engineering and testing services, SYNEREX supports qualified partners, utilities, and facility owners in the development, adaptation, and validation of ECBS-based solutions for specific applications and operating environments.
            </p>
            <p className="text-lg text-gray-200 mb-6">
    ...
    <section className="max-w-7xl mx-auto px-4 py-10 space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <a href="/oem?topic=oem&source=custom_eng_cta&utm_source=site&utm_medium=cta&utm_campaign=custom_eng_to_oem" className="px-4 py-1.5 rounded-lg bg-purple-500 hover:bg-purple-300 text-white">Request a Design Review?</a>
      </div>
    </section>
  </div>);
}
