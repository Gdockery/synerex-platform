      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Live Monitoring</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Instant Alerts</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Trend Analysis</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Network Visualization</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Performance Metrics</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Data Streaming</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">Custom Dashboards</h3>
          ...
          <div className="p-6 border bg-gray-800 rounded-lg shadow-sm">
            <h3 className="font-bold text-purple-200 mb-3">API Integration</h3>
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-purple-950/20 to-gray-900/50 rounded-xl">
          <h2 className="text-2xl font-bold text-gray-300 mb-4">Real-Time Analytics Benefits</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-purple-200 mb-2">Operational Excellence</h3>
            ...
            <div>
              <h3 className="font-semibold text-purple-200 mb-2">Business Intelligence</h3>
              <ul className="text-sm text-gray-300 space-y-1">
