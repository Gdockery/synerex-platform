      ...
      <section className="max-w-7xl mx-auto px-4 py-12 fade-in">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/ecbs-radio-control" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">ECBS Radio Control & Scheduling Devices</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/power-filtering-equipment" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Advanced 50/60Hz and Power Filtering Equipment</h3>
            </a>
          ...
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/software-controls-sensors" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">Advanced Software Controls & Sensors</h3>
            </a>
            <p className="text-sm mt-2 text-gray-300">Precision current and voltage sensors for real-time power quality monitoring.</p>
          </div>
          <div className="p-6 border border-gray-700 bg-gray-800 rounded-xl">
            <a href="/oem-hybrid-design" className="hover:text-purple-200">
              <h3 className="font-bold text-purple-200">OEM Hybrid Component Design</h3>
            </a>
