export default function Hero({ title, subtitle="", badge="", watermark=true }){
  return (
    <section className="relative min-h-[22rem] text-white flex items-start bg-gradient-to-br from-gray-900 via-purple-950 to-gray-900">
      <div className="relative max-w-6xl mx-auto px-3 py-16 w-full">
        {badge && (<div className="inline-flex items-center gap-2 rounded-full bg-purple-500 px-3 py-1.5 text-white shadow-lg ring-1 ring-purple-400/40">{badge}</div>)}
