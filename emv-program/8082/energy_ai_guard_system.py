...
class EnergyDomainGuard:
    ...
    def __init__(self):
        ...
        'xeco_equipment': [
            'synerex', 'synerex equipment', 'synerex installation', 'synerex setup',
            'synerex configuration', 'synerex programming', 'synerex maintenance',
            'synerex troubleshooting', 'synerex support', 'synerex training',
            'synerex documentation', 'synerex manual', 'synerex specifications',
            'synerex products', 'synerex catalog', 'synerex models', 'synerex series',
            'synerex power quality', 'synerex harmonic filters', 'synerex capacitors',
            'synerex reactors', 'synerex transformers', 'synerex switchgear',
            'synerex meters', 'synerex monitoring', 'synerex control systems',
            'synerex energy management', 'synerex power factor correction',
            'synerex voltage regulation', 'synerex load management',
            'synerex installation guide', 'synerex wiring diagrams',
            'synerex mounting requirements', 'synerex clearance requirements',
            'synerex electrical connections', 'synerex grounding requirements',
            'synerex commissioning', 'synerex testing procedures',
            'synerex maintenance schedules', 'synerex replacement parts',
            'synerex technical support', 'synerex warranty information'
        ],
        ...
        self.energy_contexts = [
            ...
            'synerex equipment', 'synerex installation', 'synerex setup', 'synerex configuration',
    ...
    def get_energy_suggestions(self, invalid_input: str) -> List[str]:
        ...
        suggestions = [
            ...
            "Provide SYNEREX equipment installation guidance",
            ...
            "Guide SYNEREX equipment configuration",
