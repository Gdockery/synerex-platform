...
- **Energy Standards**: 3 standards
- **Utility Rates**: 2 rate structures  
- **Equipment Specs**: 3 equipment types
- **Calculations**: 4 calculation methods
- **Troubleshooting**: 2 troubleshooting guides
- **Regional Data**: 3 regional datasets
