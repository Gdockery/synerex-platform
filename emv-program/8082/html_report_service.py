...
<html lang="en"><head><meta charset="UTF-8"><title>No Analysis Results</title>
<style>body{font-family:'Segoe UI',Arial,sans-serif;background:#f4f6f9;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0;}
...
h1{color:#1a3a5c;font-size:22px;margin-bottom:12px;}.icon{font-size:56px;margin-bottom:16px;}
p{color:#495057;font-size:15px;line-height:1.6;}
.hint{margin-top:16px;font-size:14px;color:#856404;background:#fff3cd;padding:12px 16px;border-radius:8px;}
.btn{display:inline-block;margin-top:24px;padding:10px 28px;background:#0d6efd;color:#fff;border-radius:8px;font-size:14px;text-decoration:none;}</style>
</head><body><div class="box">
<div class="icon">📊</div>
<h1>No Analysis Results Available</h1>
<p>The Executive Summary Report requires an Engineering Analysis to be run first.</p>
<div class="hint">Go back to the Engineering Analysis tab, load your project files, and click
<strong>Run Analysis</strong>. Then click <strong>Executive Summary Report</strong> again.</div>
