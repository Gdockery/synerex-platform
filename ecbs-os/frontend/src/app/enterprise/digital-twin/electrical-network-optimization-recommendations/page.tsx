...
export default async function ElectricalNetworkOptimizationRecommendationsPage() {
  const data = await getOchsnerDigitalTwinData();

  return <ElectricalNetworkScreen data={data} variant="optimizationRecommendations" />;
}
