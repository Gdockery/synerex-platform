  ...
  return (
    <EcbsAppShell activeHref="/enterprise/digital-twin/electrical-network">
      <div className="flex h-full min-h-0 flex-col px-3 py-2">
        <header className="flex h-[46px] items-center justify-between border-b border-cyan-300/10">
          <div className="text-[12px] font-semibold">XECO ENERGY INTELLIGENCE PORTAL</div>
          <div className="flex items-center gap-3 text-[9px]"><button className="w-[150px] rounded border border-slate-700 bg-[#061421] px-3 py-1.5 text-left">⌂ &nbsp; Flex Tijuana⌄</button><button className="w-[180px] rounded border border-slate-700 bg-[#061421] px-3 py-1.5 text-left">▣ &nbsp; May 12 - May 18, 2025⌄</button><span className="text-[#05ff5e]">● Live</span><span className="text-slate-400">♧</span><span className="grid size-7 place-items-center rounded-full bg-slate-700">GD</span><span>Greg Dockery<br /><span className="text-slate-400">Administrator</span></span><span>⌄</span></div>
        </header>
        <div className="flex h-[72px] items-center justify-between">
